...
BACKGROUND_IMAGES = {
    'title': 'https://images.unsplash.com/photo-1557683316-973673baf926',  # Example: abstract blue background
    'content': 'https://images.unsplash.com/photo-1557683311-eac922347aa1'  # Example: light subtle pattern
}

def apply_background_image(slide, image_url, is_title=False):
    ...
    try:
        ...
        left = Inches(0)
        top = Inches(0)
        width = Inches(10)  # Full slide width
...
def create_title_slide(prs, title, theme):
    ...
    apply_background_image(slide, BACKGROUND_IMAGES['title'], is_title=True)
...
def create_content_slide(prs, slide_data, theme):
    ...
    # Apply content background image
    apply_background_image(slide, BACKGROUND_IMAGES['content'])
